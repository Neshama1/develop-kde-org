...
description: How to make your project be a part of the KDE community
---
...
You can learn how to create CI jobs for REUSE compliance following the [Continuous Integration wiki page](https://community.kde.org/Infrastructure/Continuous\_Integration\_System).

...
![Screenshot showing 'Create app' link in KDE's Play Console account](../../../../content/docs/packaging/android/googleplay/01-create-app-1.png)
...
![Screenshot showing the 'Create app' form](../../../../content/docs/packaging/android/googleplay/01-create-app-2.png)

After creating your app you'll see the dashboard for your app with suggestions for the next steps.

![Screenshot showing the Dashboard for KTrip](../../../../content/docs/packaging/android/googleplay/01-create-app-3.png)
...
![Screenshot showing the 'Start testing now' section on the Dashboard for KTrip](../../../../content/docs/packaging/android/googleplay/02-release-for-internal-testing-1.png)
...
![Screenshot showing the 'Internal testing' page for KTrip](../../../../content/docs/packaging/android/googleplay/02-release-for-internal-testing-2.png)

Click "Create new release". This opens the page for creating an internal testing release.

![Screenshot showing the 'Create internal testing release' form with request to choose a signing key](../../../../content/docs/packaging/android/googleplay/02-release-for-internal-testing-3.png)
...
![Screenshot showing 'Choose signing key' choice](../../../../content/docs/packaging/android/googleplay/03-signing-key-and-upload-key-1.png)
...
![Screenshot showing 'App signing preferences' form](../../../../content/docs/packaging/android/googleplay/03-signing-key-and-upload-key-2.png)
...
Download KDE's [Upload Key Certificate](../../../../content/docs/packaging/android/googleplay/google-play-upload-certificate.pem).

Then click on "Show instructions" next to "For increased security, create a new upload key (optional)."

![Screenshot showing instructions for uploading an upload key certificate](../../../../content/docs/packaging/android/googleplay/03-signing-key-and-upload-key-3.png)
...
![Screenshot showing the 'Create internal testing release' form after setting the signing key with possibility to upload an app bundle](../../../../content/docs/packaging/android/googleplay/04-release-for-internal-testing-1.png)
...
![Screenshot showing the 'Create internal testing release' form after uploading an app bundle](../../../../content/docs/packaging/android/googleplay/04-release-for-internal-testing-2.png)

Then click on the "Next" button to get to the "Preview and confirm" page.

![Screenshot showing the 'Preview and confirm' step of the 'Create internal testing release' workflow](../../../../content/docs/packaging/android/googleplay/04-release-for-internal-testing-3.png)
...
![Screenshot showing the details for the uploaded app bundle](../../../../content/docs/packaging/android/googleplay/04-release-for-internal-testing-4.png)

Then we switch to the Downloads page.

![Screenshot showing the available downloads for the uploaded app bundle](../../../../content/docs/packaging/android/googleplay/04-release-for-internal-testing-5.png)
...
![Screenshot showing the 'Publish change on Google Play?' confirmation question](../../../../content/docs/packaging/android/googleplay/04-release-for-internal-testing-6.png)

This concludes the creation of the first internal release of KTrip.

![Screenshot showing the 'Internal testing' page listing the first release](../../../../content/docs/packaging/android/googleplay/04-release-for-internal-testing-7.png)
...
![Screenshot showing the 'Set up your app' task list on KTrip's dashboard](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-00.png)
...
![Screenshot showing the 'Privacy Policy' form](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-01-1.png)

Then we click "Save" and go back to the Dashboard.

![Screenshot showing the 'Set up your app' task list on KTrip's dashboard where now 1 of 12 tasks is complete](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-01-2.png)
...
![Screenshot showing the 'Ads' form](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-03.png)

**Content rating**

Now it gets a bit more interesting. Although for KTrip it's rather boring.

![Screenshot showing the starting page of the 'Content ratings' questionnaire](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-04-0.png)
...
![Screenshot showing the Category form of the 'Content ratings' questionnaire](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-04-1.png)

On the next page we can quickly answer the first two questions with "No".

![Screenshot showing the first two questions of the 'Content ratings' questionnaire](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-04-2-1.png)
...
![Screenshot showing the questions about online content of the 'Content ratings' questionnaire](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-04-2-2.png)

The remaining questions can again quickly be answered with "No".

![Screenshot showing the remaining questions of the 'Content ratings' questionnaire](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-04-2-3.png)

After saving our answers and clicking "Next" we get to the summary.

![Screenshot showing the summary of the 'Content ratings' questionnaire](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-04-3.png)
...
![Screenshot showing the question about the target age of the 'Target audience and content' questionnaire](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-05-1.png)
...
![Screenshot showing the question about the store presence's appeal to children of the 'Target audience and content' questionnaire](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-05-4.png)

After clicking "Next" we get to the summary where we save our answers.

![Screenshot showing the summary of the 'Target audience and content' questionnaire](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-05-5.png)

**News apps**

No, KTrip isn't a news app.

![Screenshot showing the question whether KTrip is a news app](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-06.png)

**COVID-19 contact tracing and status apps**

Neither KTrip is a publicly available COVID-19 contact tracing or status app.

![Screenshot showing the question whether KTrip is a publicly available COVID-19 contact tracing or status app](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-07.png)

**Data safety**

Next we need to "help users understand how" KTrip "collects and shares their data".

![Screenshot showing the 'Overview' page of the 'Data safety' questionnaire](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-08-1.png)
...
![Screenshot showing the 'Data collection and security' page of the 'Data safety' questionnaire](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-08-2.png)

The preview shows what will be shown to users on Google Play for KTrip.

![Screenshot showing the 'Store listing preview' of KTrip's 'Data safety'](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-08-5.png)

**Government apps**

No, KTrip was not developed by or on behalf of a government.

![Screenshot showing the question whether KTrip was developed by or on behalf of a government](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-09.png)

**Financial features**

KTrip doesn't provide any financial features ...

![Screenshot showing the 'Financial features' form](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-10-1.png)

... so that we don't have to provide any additional documentation.

![Screenshot showing which additional documentation for the financial features we need to submit](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-10-2.png)

This completes the long list of tasks to let Google Play know about the content of KTrip.

![Screenshot showing the 'Set up your app' task list on KTrip's dashboard where now 10 of 12 tasks are complete](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-10-3.png)
...
![Screenshot showing the 'App category' form of the 'Store settings'](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-11-1.png)
...
![Screenshot showing the 'Store listing contact details' form of the 'Store settings'](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-11-2.png)

Finally, we leave external marketing enabled.

![Screenshot showing the 'External marketing' choice of the 'Store settings'](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-11-3.png)
...
![Screenshot showing the 'Listing assets' form of the 'Main store listing'](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-12-1.png)
...
![Screenshot showing the 'Graphics' form of the 'Main store listing'](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-12-2.png)
...
![Screenshot showing the 'Phone screenshots' form of the 'Main store listing'](../../../../content/docs/packaging/android/googleplay/05-set-up-your-app-12-3.png)
...
![Screenshot showing the 'Internal testing' page with 'Promote release' pop-up](../../../../content/docs/packaging/android/googleplay/06-create-draft-releases-1.png)
...
![Screenshot showing the 'Create open testing release' form with the promoted internal release](../../../../content/docs/packaging/android/googleplay/06-create-draft-releases-2.png)
...
![Screenshot showing the 'Internal testing' page with 'Promote release' pop-up where 'Open testing' is disabled](../../../../content/docs/packaging/android/googleplay/06-create-draft-releases-3.png)

Again the new release is created immediately and has automatically been saved as draft.

![Screenshot showing the 'Create production release' form with the promoted internal release](../../../../content/docs/packaging/android/googleplay/06-create-draft-releases-4.png)
